...
const daoStakerPercentage = require('./daoStakerPercentage');
...
const feesCollected = require('./feesCollected');
...
module.exports = app => {
  ...
  app.command('daoShouldBurnReward', daoShouldBurnReward());
  app.command('daostakerreward', daoStakerPercentage());
  app.command('daoStakerReward', daoStakerPercentage());
  ...
  app.command('feeSanityRates', feeSanityRates());
  app.command('feescollected', feesCollected());
  app.command('feesCollected', feesCollected());
