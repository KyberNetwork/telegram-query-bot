...
const ratesWithConfig = require('./ratesWithConfig');
...
const slippageWithConfig = require('./slippageWithConfig');
const spread = require('./spread');
const spreadWithConfig = require('./spreadWithConfig');
...
module.exports = (app) => {
  ...
  app.command('rateswithconfig', ratesWithConfig());
  app.command('ratesWithConfig', ratesWithConfig());
  ...
  app.command('slippagewithconfig', slippageWithConfig());
  app.command('slippageWithConfig', slippageWithConfig());
  app.command('spread', spread());
  app.command('spreadwithconfig', spreadWithConfig());
  app.command('spreadWithConfig', spreadWithConfig());
